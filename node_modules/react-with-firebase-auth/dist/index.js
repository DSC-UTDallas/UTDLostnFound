    ...
    return function (WrappedComponent) {
        ...
        return _a = /** @class */ (function (_super) {
                ...
                function FirebaseAuthProvider() {
                    ...
                    _this.signOut = function () { return _this.tryTo(function () { return firebaseAppAuth.signOut(); }); };
                    _this.signInAnonymously = function () { return _this.tryTo(function () { return firebaseAppAuth.signInAnonymously(); }); };
                    ...
                    _this.signInWithFacebook = function () { return _this.tryToSignInWithProvider('facebookProvider'); };
                ...
                FirebaseAuthProvider.prototype.render = function () {
                    var props = __assign({}, this.props, { signInWithEmailAndPassword: this.signInWithEmailAndPassword, createUserWithEmailAndPassword: this.createUserWithEmailAndPassword, signInWithGithub: this.signInWithGithub, signInWithTwitter: this.signInWithTwitter, signInWithGoogle: this.signInWithGoogle, signInWithFacebook: this.signInWithFacebook, setError: this.setError, signInAnonymously: this.signInAnonymously, signOut: this.signOut, user: this.state.user, error: this.state.error });
